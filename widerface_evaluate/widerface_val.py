...
from widerface_evaluate.data.wider_face import WIDERFace_ROOT, WIDERFaceAnnotationTransform, WIDERFaceDetection
# from face_ssd import build_ssd

plt.switch_backend('agg')

parser = argparse.ArgumentParser(description='EfficientFaceNet')
parser.add_argument('-m', '--trained_model', default="weights/efficientface-d0/efficientface-d0_50.pth",
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--save_folder', default='./widerface_evaluate/widerface_txt_val_multiscale/', type=str,
                    help='Dir to save txt results')
parser.add_argument('--visual_threshold', default=0.01, type=float,
                    help='Final confidence threshold')
parser.add_argument('--cuda', default=True, type=bool,
                    help='Use cuda to train model')
parser.add_argument('--widerface_root', default='./data/widerface',
