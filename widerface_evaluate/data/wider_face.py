...
WIDERFace_ROOT = '/home/can/AI_Camera/EfficientFaceNet/data/widerface'
...
class WIDERFaceDetection(data.Dataset):
    ...
    def __init__(self, root,
        ...
        if self.image_set == 'train':
            ...
            path_to_image = osp.join(self.root, 'train/images')
            fname = 'wider_face_train.mat'

        if self.image_set == 'val':
            path_to_label = osp.join(self.root, 'wider_face_split')
            path_to_image = osp.join(self.root, 'val/images')
            fname = 'wider_face_val.mat'

        if self.image_set == 'test':
            path_to_label = osp.join(self.root, 'wider_face_split')
            path_to_image = osp.join(self.root, 'test/images')
